...
function HeroGrid() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      />
      {/* Gold glow top-right */}
      <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-[#D4AF37]/[0.06] blur-[120px]" />
...
function ProcessConnector() {
  return (
    <div className="hidden lg:flex items-center justify-center">
      <div className="w-full h-px bg-gradient-to-r from-[#D4AF37]/30 via-[#D4AF37]/15 to-transparent" />
    </div>
  );
}
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-28 pb-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-[clamp(2.8rem,8vw,5.5rem)] font-bold leading-[1.05] tracking-[-0.02em] mb-8">
            ...
            <br />
            <span className="text-[#1A1A1A]">MARKETS MOVE.</span>
          </h1>
          <p className="text-[#6B6B76] text-base sm:text-lg max-w-xl mx-auto leading-relaxed mb-12 font-normal">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#contact"
              className="bg-[#D4AF37] text-white px-8 py-3.5 text-[13px] font-semibold tracking-[0.1em] uppercase hover:bg-[#E2BE4D] transition-colors"
            >
              Start the Conversation
            </a>
            <a
              href="#network"
              className="border border-[#D4AF37]/40 text-[#D4AF37] px-8 py-3.5 text-[13px] font-semibold tracking-[0.1em] uppercase hover:border-[#D4AF37]/70 hover:bg-[#D4AF37]/5 transition-colors"
            >
              Learn More
            </a>
          </div>
      ...
      <section className="py-16 sm:py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-12 h-px bg-[#D4AF37]/50 mx-auto mb-10" />
          <p className="text-2xl sm:text-3xl md:text-4xl font-light text-[#6B6B76] leading-relaxed tracking-wide">
            WHERE{" "}
            <span className="text-gradient-gold font-bold">ACCESS</span>{" "}
            BECOMES{" "}
            <span className="text-gradient-gold font-bold">OPPORTUNITY</span>.
          </p>
          <div className="w-12 h-px bg-[#D4AF37]/50 mx-auto mt-10" />
        </div>
      </section>
      ...
      <section id="network" className="py-16 sm:py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-[#6B6B76] mt-4 max-w-lg mx-auto text-sm sm:text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {networkItems.map((item) => (
              <div
                key={item.title}
                className="group bg-[#FAFAF7] border border-[#D4AF37]/10 p-7 sm:p-8 hover:border-[#D4AF37]/30 transition-colors duration-300"
              >
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-[#D4AF37]/30 text-2xl font-bold tabular-nums">
                    {item.number}
                  </span>
                  <div className="flex-1 h-px bg-[#D4AF37]/15" />
                </div>
                <h3 className="text-lg font-semibold text-[#1A1A1A] mb-2.5">
                  {item.title}
                </h3>
      ...
      <section className="py-16 sm:py-20 px-6 bg-[#F9F7F2] relative overflow-hidden">
        {/* Subtle visual */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full bg-[#D4AF37]/[0.04] blur-[100px]" />
          <div
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-6 leading-tight text-[#1A1A1A]">
            Not Everything of Value
            <br />
            Reaches the Open Market
          </h2>
          <p className="text-[#6B6B76] text-base sm:text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-[13px] tracking-[0.08em]">
            ...
            <span className="text-[#D4AF37]/30">&middot;</span>
            <span className="text-[#D4AF37] font-medium">
              Selective by Design
            </span>
            <span className="text-[#D4AF37]/30">&middot;</span>
      ...
      <section id="process" className="py-16 sm:py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-[2.5rem] font-bold tracking-tight leading-tight max-w-3xl mx-auto text-[#1A1A1A]">
            ...
            {processSteps.map((step, i) => {
              ...
              return (
                <div key={step.number} className="text-center">
                  <span className="text-[#D4AF37]/25 text-3xl sm:text-4xl font-bold tabular-nums block mb-3">
                    {step.number}
                  </span>
                  <h3 className="text-lg sm:text-xl font-semibold text-[#D4AF37] mb-2">
                    {step.title}
                  </h3>
                  <p className="text-[#6B6B76] text-sm leading-relaxed max-w-[200px] mx-auto">
                    {step.description}
                  </p>
                </div>
              );
          ...
          <p className="text-center mt-12 text-[#6B6B76] text-[13px] tracking-[0.05em]">
      ...
      {/* ───── STANDARDS ───── */}
      <section id="standards" className="py-16 sm:py-20 px-6 bg-[#F9F7F2]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-[#D4AF37] text-[11px] tracking-[0.3em] uppercase mb-3 font-medium">
              Our Standard
            ...
            {standards.map((item, i) => (
              <div
                ...
                className={`p-8 sm:p-10 ${
                  i < 2 && i % 2 === 0
                    ? "md:border-r border-[#D4AF37]/10"
                    : ""
                } ${i < 2 ? "md:border-b border-[#D4AF37]/10" : ""} ${
                  i === 1 ? "md:border-b border-[#D4AF37]/10" : ""
                }`}
              >
                <div className="w-8 h-px bg-[#D4AF37]/50 mb-6" />
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3 tracking-tight">
                  {item.title}
                </h3>
                <p className="text-[#6B6B76] text-[15px] leading-relaxed">
                  {item.description}
                </p>
              </div>
            ))}
      ...
      <section className="py-16 sm:py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-5 text-[#1A1A1A]">
            Ouahid Kachkachi
          </h2>
          <p className="text-[#6B6B76] text-base leading-relaxed">
      ...
      {/* ───── FINAL CTA ───── */}
      <section id="contact" className="py-20 sm:py-24 px-6 bg-[#1A1A1A] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-[#D4AF37]/[0.05] blur-[100px]" />
        </div>
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-4 leading-tight text-white">
          ...
          <p className="text-[#9B9BA6] text-base leading-relaxed mb-12 max-w-lg mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="flex items-center justify-center gap-3 bg-[#D4AF37] text-[#1A1A1A] px-8 py-3.5 text-[13px] font-semibold tracking-[0.1em] uppercase hover:bg-[#E2BE4D] transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 border border-white/15 text-white px-8 py-3.5 text-[13px] font-semibold tracking-[0.1em] uppercase hover:border-white/30 hover:bg-white/5 transition-colors"
            >
      ...
      {/* ───── FOOTER ───── */}
      <footer className="py-10 px-6 bg-[#1A1A1A] border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto">
          {/* Top row */}
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-8">
            <div>
              ...
              />
              <p className="text-[#9B9BA6] text-sm">Commercial Brokers</p>
            </div>
            <div className="flex gap-12">
              <div className="flex flex-col gap-2">
                <span className="text-[11px] text-[#9B9BA6]/60 tracking-[0.15em] uppercase mb-1">Navigate</span>
                {[
                  ...
                  <a
                    key={link.href}
                    href={link.href}
                    className="text-[13px] text-[#9B9BA6] hover:text-[#D4AF37] transition-colors"
                  >
                    {link.label}
                  </a>
                ))}
              ...
              <div className="flex flex-col gap-2">
                <span className="text-[11px] text-[#9B9BA6]/60 tracking-[0.15em] uppercase mb-1">Contact</span>
                <a href="https://wa.me/971585930397" target="_blank" rel="noopener noreferrer" className="text-[13px] text-[#9B9BA6] hover:text-[#D4AF37] transition-colors">
                  WhatsApp
                </a>
                <a href="mailto:contact@kingmakerscb.com" className="text-[13px] text-[#9B9BA6] hover:text-[#D4AF37] transition-colors">
                  Email
                </a>
              </div>
            </div>
          ...
          {/* Bottom row */}
          <div className="border-t border-white/[0.06] pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-[12px] text-[#9B9BA6]/60">
